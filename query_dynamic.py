...
def main():
    ...
    processor = Processor(index_path, query_path)
...
class Processor:
    def __init__(self, index_path, query_path, n_gram=2, window_size=5, retrieval_threshold=10):
...
#                                print(set(window))
#                                print(sum(tid in set(window) for tid in q_tids))
                                if len(set(window)) == self.n_gram:
                                    tf += 1
                                break
